 ...
 * 
 * Abstract Description: Using GTK bulid the friend box which looks like Wechat friend list.
****************************************/
...
//Load the name label of your friends
